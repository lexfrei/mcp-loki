...
When `summary_only=true`, the response includes auth, retention, ruler API availability, and selected ingestion/query limits instead of the full configuration dump.
